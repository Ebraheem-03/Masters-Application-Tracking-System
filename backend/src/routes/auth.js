...
router.post('/forgot-password', [
  ...
  try {
    ...
    // Generate OTP
    const otp = await User.generatePasswordResetOTP(user._id);
...
router.post('/reset-password', [
  ...
  try {
    ...
    // Verify OTP
    const isOTPValid = await User.verifyPasswordResetOTP(user._id, otp);
    if (!isOTPValid) {
      return res.status(400).json({
        success: false,
    ...
    // Clear OTP
    await User.clearPasswordResetOTP(user._id);
